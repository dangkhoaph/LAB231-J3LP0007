 ...
 * @author KhoaPHD
 */
@WebServlet(name = "BackQuestionController", urlPatterns = {"/BackQuestionController"})
public class BackQuestionController extends HttpServlet {

    private static final Logger LOGGER = Logger.getLogger(BackQuestionController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                session.setAttribute("CURRENT_QUESTION", currentQuestion - 1);
